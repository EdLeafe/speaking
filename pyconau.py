...
image_id = "fb61c42c-b65c-45f0-b1b8-20bd5e47de32"
...
db_instance = cdb.create("PyConAU_DB", flavor=1, volume=2)
...
server1 = cs.servers.create("PyConAU_Srv1",
        image=image_id, flavor=2, key_name="macbook",
        nics=networks)
server2 = cs.servers.create("PyConAU_Srv2",
        image=image_id, flavor=2, key_name="macbook",
        nics=networks)
...
lb = clb.create("PyConAU_LB", port=80, protocol="HTTP",
...
server3 = cs.servers.create("PyConAU_Srv3",
        image=image_id, flavor=2, key_name="macbook",
        nics=networks)
